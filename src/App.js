...
// added custom widget for bounty
...
export default function App() {
  const [widgets, setWidgets] = useState([
    ...
    { id: new Date().getTime() + 1, component: <TimerWidget />, area: 'none-widget', name: "Timer" },
    { id: new Date().getTime() + 3, component: <MyCustomWidget />, area: 'left-widget', name: "Stop Watch" },
  ]);
      ...
      <div className="none-widget">
        {widgets.length > 0 &&
          widgets.map((widget, index) => {
            ...
            return null; // added null return to satisfy React requirement
          })}
      </div>
      <div className="App">
